...
Live site: **https://lkbell.github.io/sit-rep/** — 71 indicator charts, 10 domains + an Overview page of 16 vital signs with a signals strip. Purpose: Landon's ground-truth situational awareness. Data auto-refreshes via GitHub Actions (weekdays 14:23 UTC + on any pipeline push); the site is pure static files on GitHub Pages.
